/*
Package cue provides CUE evaluation and validation capabilities for the Catalyst Forge platform.
...
validating it against a schema, and decoding it into a Go struct.
	...
	import (
		...
		"github.com/input-output-hk/catalyst-forge-libs/cue"
...
to be resolved at runtime (e.g., artifact URIs, secrets, etc.).
	...
	import (
		...
		"cuelang.org/go/cue"
		"github.com/input-output-hk/catalyst-forge-libs/cue"
		cueattrs "github.com/input-output-hk/catalyst-forge-libs/cue/attributes"
		"github.com/input-output-hk/catalyst-forge-libs/fs/billy"
	)
...
# Related Packages
  ...
  - github.com/input-output-hk/catalyst-forge-libs/errors - Platform error handling
  - github.com/input-output-hk/catalyst-forge-libs/fs/core - Filesystem abstraction interfaces
  - github.com/input-output-hk/catalyst-forge-libs/fs/billy - Billy filesystem wrapper
